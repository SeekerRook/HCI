                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        onTap: (() {
                          Navigator.pop(context);
                          global_controller.center = LatLng(global_action[data[0]]!.x, global_action[data[0]]!.y);  
                          center.value = LatLng(global_action[data[0]]!.x, global_action[data[0]]!.y);
                          // Navigator.push(
                          //   context,
                          //   MaterialPageRoute(
                          //       builder: (context) => MainPage(
                          //           pos: LatLng(global_action[data[0]]!.x,
                          //               global_action[data[0]]!.y))),
